---
title: "Community Recommended Pathways/Research"
---
...
- **Action Steps**:
  - **Join the Group**: Access the [Research Chat Signal Group](https://signal.group/#CjQKIEbEBKwgjZSTFCckWYk0vwkxxo5zcqzBr9Ar6KO4RaOwEhAaczI15rpGyf-BgFx9kT5f).
...
- **Resources**:
  - **Wiki Learning Page**: [DoD Learning Resources](/general/learning)
...
- **Options**:
  - **OSINT Dojo Resources**: [OSINT Dojo](https://www.osintdojo.com/resources/)
...
- **Research Inspired by the Intel Cycle**: Utilize the four main steps of research inspired by the Intel Cycle.
  - **Plan and Prepare**: See the [Research Preparation Guide](/research/research-preparation).
  - **Gather**: Access [Research Datasets](/research/research-datasets) and [Research Tools](/research/research-tools).
...
- **Research Guides**:
  - **OSINT in 5 Hours**: [YouTube Video](https://www.youtube.com/watch?v=qwA6MmbeGNo)

- **Tools**:
  - **Elicit**: [elicit.org](https://elicit.org/) - Automate research workflows.
  - **PAI-Dashboard**: [PAI-Dashboard](https://www.pai-dashboard.com/) - Current events and analysis.
  - **WorldCat**: [worldcat.org](https://www.worldcat.org) - Global library catalog.
  - **Google Dataset Search**: [datasetsearch.research.google.com](https://datasetsearch.research.google.com)
  - **Mendeley**: [mendeley.com](https://www.mendeley.com) - Reference management.
