...
1. Select the "Edit source" option above.
2. Copy all the content below, including the headers and formatting syntax.
3. Replace all placeholders enclosed in double square brackets (e.g., `[BEHAVIOR]`, `[COUNTRY]`) with your specific information.
4. Search for the term "DESIRED_BEHAVIOR in COUNTRY_HERE".
   - If the page does not exist, select "Create Page" at the top of the results.
5. Paste the content you copied in Step 2 into the new page.
6. Remove this instruction section above the "snip line here".
7. Save the new page.
...
**Action or Behavior**: [BEHAVIOR] in [COUNTRY]
