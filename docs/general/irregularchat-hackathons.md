---
title: "IrregularChat Hackathons"
---
...
1. **Safety Second** – Prioritize progress and execution; cybersecurity perfection can wait for prod.

1. **It Stays on the Community Repo** – All work should be committed to the shared repository for transparency and collaboration.

1. **No Assigned Work Stuff** – These events are about building cool, useful things, not working on employer-assigned projects.

1. **Ship Ugly, Ship TODAY.** – Rapid iteration is the priority; push code, get feedback, improve.

1. **Create Reusable Components** – Build components that can be reused in future projects.

1. **Document Your Intention, Document Your Code** – Clarity in goals and documentation ensures that others can contribute effectively.
...
### Past Projects
**Barracks Lawyer** – [Project](http://barracks-law.irregulars.ioDeployed) | [GitHub Repo](https://github.com/irregularchat/barracks-lawyer) |[Forum Post](https://forum.irregularchat.com/t/mini-virtual-hackathon-recap-pettty-officer/2280)
...
Perfect Date Generator - [Project](https://perfectdate.irregulars.io) | [GitHub Repo](https://github.com/irregularchat/Perfect-Date) | [Forum Post](https://forum.irregularchat.com/t/mini-virtual-hackathon-project-perfectdate-generator/3454)
...
- Find the Chat by Submitting code to [Full Stack Repo ](https://github.com/irregularchat/Full-Stack-Chat)

- [IrregularChat Forum Hackathon Tag](https://forum.irregularchat.com/tag/hackathon)

- [Community GitHub](https://github.com/irregularchat)
