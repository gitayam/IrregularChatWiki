...
## PMESII-PT Framework
Return to the main [section](/research/).
...
First, a [of Gravity (COG)](/general/center-of-gravity-analysis-guide) analysis must be completed to identify critical vulnerabilities. These vulnerabilities should be prioritized and then weighed against the PMESII-PT factors.
...
Once the PMESII-PT analysis is complete, you can assess how each factor influences the [and adjust the strategy accordingly.
