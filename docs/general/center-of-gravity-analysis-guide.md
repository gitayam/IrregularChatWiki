---
title: "Center of Gravity Analysis Guide"
---
...
Joint Publication (JP) 1-02 defines COG as “those characteristics, capabilities, or sources of power from which a military force derives its freedom of action, physical strength, or will to fight.”

JP 3-0 defines  COG as "the source of power that provides moral or physical strength, freedom of action, or will to act.”

### Objectives and Detailed Questions

### Identify the COG
Accurately identifying the COG is critical for successful operational planning. This thoroughly analyzes friendly forces, adversaries, and other relevant actors such as host nations.
...
Refer to the [(Political, Military, Economic, Social, Information, Infrastructure, Physical Environment, Time) framework to comprehensively understand the operational environment.
...
1. **Clarity**: Define the meaning of each score at the outset, including whether higher or lower scores represent more or less advantage, risk, or priority.

1. **Adaptability**: Be prepared to adjust the scoring system based on the specific requirements of the operation or mission.

1. **Training**: Provide sufficient training to ensure that all analysts and planners understand how to apply the scoring system correctly.
...
| Vulnerability | Impact on COG (I) | Attainability (A) | Follow-Up (F) | Score |
|---------------|-------------------|-------------------|---------------|-------|
...
- **SWOT Analysis](/general/pmesii-pt)**: Evaluate Strengths, Weaknesses, Opportunities, and Threats for each COG.

- **[Framework](/general/pmesii-pt)**: Analyze the operational environment comprehensively.

- **Systems Thinking**: Understand the interdependencies within the operational environment.

- **[Teaming](/general/structured-analytic-techniques-sats)**: Use adversarial thinking to challenge assumptions and identify vulnerabilities.
