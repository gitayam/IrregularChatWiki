...
See the following resource for the NPS Guide to citing military reports, orders, and even meetings: [NPS Citation Guide](https://libguides.nps.edu/citation).

### HOW TO CITE with FOOTNOTES on WORD

## Open Word (Desktop App works best; Web has limitations).

## After writing sourced information, highlight all related text.
...
- Create a bibliography page at the end of the TAAW.
  - All sourced information should be included here with full sourcing.
    - I.E. National Geographic, Indigenous beliefs, 5/6/2024, [www.natgeo.com](http://www.natgeo.com).
