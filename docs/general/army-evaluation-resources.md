---
title: "Army Evaluation Resources"
---
...
[HQDA Evals Page: https://www.hrc.army.mil/](https://www.hrc.army.mil/content/Evaluation%20Systems%20Homepage)

- [623–3](#) and [PAM 623–3](#) – Primary regulations guiding evaluations.

#### Officer Evaluation Reports (OER):
  - [Grade OER](#)
  - [Grade OER](#)
  - [Grade OER (O6)](#)
  - [Officer OER](#) [Direct Link](https://armypubs.army.mil/pub/eforms/DR_a/pdf/ARN17086_A67_10_1A_FINAL.pdf)
  - [Support Form](#)

#### Noncommissioned Officer Evaluation Reports (NCOER):
  - [Evaluation Report (SGT).pdf](#) [Direct Link](https://armypubs.army.mil/pub/eforms/DR_a/pdf/DA%20FORM%202166-9-1.pdf)
  - [(SSG-1SG/MSG)](#)
  - [(CSM-SGM)](#)
  - [Support Form](#)
  - [Form 2166-9 Series Guide](#)
Academic Evaluation Reports (AER): DA Form 1059 Series – Used for academic performance evaluations.

#### Counseling Tools:
  - [Counseling Form](#) [Direct Link](https://armypubs.army.mil/ProductMaps/PubForm/Details.aspx?PUB_ID=1026753)
  - [Counseling Checklist/Record](#)

#### AI Enabled Online Resources:
  - [Armified](https://www.armified.com/) – A free (beta) platform offering templates and sample approaches.
  - [RapidEPR](https://rapidepr.com/) – A long-standing resource for multi-branch evaluations.
  - [AI Prompt](/ai-ml/evaluation-ai-prompt) – Template to structure prompts for Large Language Models, assisting in drafting initial bullet comments or narratives.
...
1. **Developmental Focus:** Use counseling and mentorship to build stronger Soldiers, ensuring top achievers emerge naturally.

1. **Long-Term Profile Management:** Resist the urge to give everyone top marks; reserving MQ for the few who merit it enhances the Rater’s credibility.

1. **Army Values and Leadership Attributes:** Consider ethics, leadership, technical skill, and potential for advancement, not just immediate results.
...
The following FAQs provide a snapshot of common concerns and clarifications drawn from the doctrine and references uploaded. While these answers serve as an accessible guide, always consult the most current versions of *623–3 Evaluation Reporting System (ERS)* and *PAM 623–3 Evaluation Reporting System (ERS)* for definitive policy and procedural guidance.

- [HQDA NCOER FAQ](https://www.hrc.army.mil/content/18837)
