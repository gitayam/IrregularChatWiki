...
- **Phishing and Spear Phishing**: Deceptive emails that attempt to collect sensitive information. See [Teaming Phishing and Smishing Guide](/general/phishing).
...
For a more expansive guide and the source to this section, see [PrivacyGuides](https://www.privacyguides.org/en/email/)

- **[Disroot](https://disroot.org/)**: More than just email and focused on privacy and security allowing smtp, imap, and gpg/pgp. It takes several days to have your account request approved but it is real.

- **[ProtonMail](https://protonmail.com)**: Offers end-to-end encryption and advanced security features.

- **[Tutanota](https://tutanota.com)**: Provides secure, encrypted email storage and messaging.

- **[Mailbox.org](https://mailbox.org)**: Focused on privacy and ad-free service.

- **[StartMail](https://startmail.com)**: Easy-to-use encrypted email for businesses and individuals.

### Recommended Email Clients
For a more expansive guide and the source to this section see [PrivacyGuides](https://www.privacyguides.org/en/email-clients/)

- **[Thunderbird (Desktop & MacOS)](https://www.thunderbird.net/en-US/)**

- **[CanaryMail (MacOS & iOS)](https://canarymail.io/downloads.html)**

- **[FairMail (Android)](https://play.google.com/store/apps/details?id=eu.faircode.email&pcampaignid=web_share)**

### Email Aliasing
For a more expansive guide and the source to this section see [PrivacyGuides](https://www.privacyguides.org/en/email-aliasing/)
...
- **[SimpleLogin](https://simplelogin.io)**: Offers free and premium aliasing services, with integration for ProtonMail.

- **[Addy.io](https://addy.io)**: Free plan with 10 shared and unlimited "standard" aliases.

- **[AnonAddy](https://anonaddy.com)**: Open-source aliasing service with robust privacy features.
...
- **[Mailvelope](https://mailvelope.com/en/)**: A browser extension that enables end-to-end encryption on top of existing email services like Gmail and Yahoo Mail.
...
- Create passwords with a minimum of 16 characters that include a mix of letters, numbers, and symbols. Refer to the [Manager Guide](/general/guide-to-password-managers).

- Avoid using easily guessable passwords such as sequential letters or numbers.

### Enable Multi-Factor Authentication (MFA)

- Enable MFA on all email accounts to require a second verification form besides the password. This can be a code from an app like Google Authenticator or a text message. See [Guide](/general/mfa-guide).
...
- **Strongly consider using a password manager** to generate and store complex passwords. This is essential for maintaining strong security across multiple accounts. See the [Manager Guide](/general/guide-to-password-managers).
...
- **Educational Resources**: Continuously educate yourself about email security through resources and updates. Example: [Stay Safe Online’s Email Security Tips](https://staysafeonline.org/email-security/).

### Additional Resources

- [Google Phishing Virtual Environment Training](https://phishingquiz.withgoogle.com)

- [Guide to Using ProtonMail for Secure Email](https://protonmail.com/support/)
