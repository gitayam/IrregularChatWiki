...
Use this template with [Ai on government systems](https://intellipedia.intelink.gov/wiki/Ai_on_government_systems)
...
### Example Bullets
- RANK LAST distinguished himself as a leader for [FUNCTIONAL TEAM](CROSS) while enhancing the tactical and operational capacity of [partners to further enable NATO integration. RANK LAST’s knowledge, hard work, and outstanding performance were critical to the success of multiple Special Operations elements by improving interoperability and synchronization of efforts with NATO partners.

- While serving as the primary lane manager for [EXERCISE NAME](NUMBER]), RANK LAST planned and executed a complex irregular warfare scenario for over [USSOF and [NUMBER](NUMBER]) partner personnel. Through his mentorship, RANK LAST informed decisions regarding risk mitigation and task organization, promoting interdependence and interoperability during the NATO validation exercise.

- RANK LAST combined disparate reports into an accurate depiction of [defensive tactics, techniques, and procedures. The resulting product was used to update training programs and develop a breach and clear program of instruction for a company of [COUNTRY](COUNTRY]) Special Operations Forces (SOF) soldiers preparing for their rotation to the line of contact.

- RANK LAST volunteered to act as the personnel movement coordinator for [GROUP](TASK). While serving in this capacity, he coordinated the arrival, transportation, and departure of over [personnel throughout the deployment. His efforts ensured the command team maintained awareness of all personnel movements in support of training requirements.
...
## Identify the rank and name of the service member.

## Specify the duty title and the unit they served with.

## Describe the operation or mission they were involved in, including the time period.
