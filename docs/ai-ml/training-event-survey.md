---
title: "Training Event Survey"
---

# Training Event Survey

## Training Event Survey Workflow Guide
...
***CryptPad**: A secure, end-to-end encrypted collaborative platform that does not require a login, allowing participants to respond anonymously. [CryptPad](https://cryptpad.fr)
  - No Login Required to Create
  - No Login Required to Participate
  - Free
  - End-to-End Encrypted (Server can't see your data)
***Army 365**: Forms can be made available to the public, and the DoD protects and serves the form. [** Login is Required to Create
  - No Login Required to Participate
  - Free
  - .mil in URL
***Google Forms**: User-friendly and integrates easily with Google Sheets for data analysis. [https://forms.google.com Google Forms](https://forms.osi.apps.mil/])
  - Login is Required to Create
  - No Login Required to Participate
  - Free
...
- Generate QR codes to distribute surveys easily using services like [QRStuff](https://www.qrstuff.com) or [QR Code Generator](https://www.qr-code-generator.com).
