---
title: "Signal Welcome Prompts"
---

# Signal Welcome Prompts

Admin Signal Welcome Prompts
For Admin, See the [Mod Portal](https://mod.irregular.chat) to create users and more

- Back to main [page](/general/admin)

- [Links](/general/links) with all the chats
...
### Tech Chat
[Recommended Pathways](/community/community-recommended-pathways)
...
- Resources for Learning: Check out some fantastic resources shared within our group at https://irregularpedia.org/general/learning
...
### Influence Chat
[Strategy and Reports](/general/national-strategy-and-reports)```
...
Check out some resources for learning shared with the group: https://irregularpedia.org/general/learning

National Strategic Documents and Reports: https://irregularpedia.org/general/national-strategy-and-reports
...
## What innovative projects are you or your unit currently exploring?
...
Help Expand the known resources by reviewing:  https://irregularpedia.org/research/
...
AI/ML Wiki - https://irregularpedia.org/ai-ml/
AI/ML Forum: https://forum.irregularchat.com/tag/ai
```


### DragonOS Chat
[chat page](/radio/dragonos)
...
- Download ISO: https://sourceforge.net/u/cemaxecuter/profile/
- Wiki Section: https://irregularpedia.org/radio/dragonos
...
### SPACE Chat
```
🚀 Welcome to the Space Capabilities & Innovation Chat! 🌌

This group is dedicated to unclassified discussions on space capabilities, technology, news, and strategic developments. Whether you’re interested in unclassified discussions of orbital warfare, ISR advancements, commercial space integration, or space-based communications, this is the place to stay informed, collaborate, and share insights.
📚 Space Capabilities Wiki: https://irregularpedia.org/general/
🌍 Community Forum: https://forum.irregularchat.com/tag/space
📁 Unclassified Files shared in the chat: https://u.pcloud.link/publink/show?code=kZ7qV85ZwCUR8nO0Lsj6VyzdJTu9XFR6BBMV

🛰️ Get Involved!
• Introduce yourself – What’s your background or interest in space?
• Share news & research – Relevant articles, white papers, and space-related reports.
• Organize & connect – If you’re involved in space-related initiatives, drop your details and engage with the community.

```


### sUAS - Unmanned Systems Chat - Drones and Robotics
[Systems chat page](/general/unmanned-systems)
...
Remember, the forum is unclassified, unaffiliated to any organization, and not limited to USG or DOD.

Resources, Guides, and precious gems from the conversation can be found and edited here. Learn about the community before jumping in.
https://irregularpedia.org/general/unmanned-systems

Previously shared files are found here - https://url.irregular.chat/unmanned-drive the password, with spaces, is:

Anymore01!@Shadow01!@Unkempt
```


### Counter UxS: Countering Uncrewed Systems
[ Counter UxS Wiki Page](/general/counter-uxs)
```
...
Previously shared files are found here - https://url.irregular.chat/cuxs-drive
...
### Off-Topic Chat
[Off Topic Forum](https://forum.irregularchat.com/c/off-topic-guild/5)

```
If it's you're first day in off-topic chat, you gotta meme.
...
### Purple Teaming Chat
[Teaming Chat DFP Guide](/cybersecurity/cyber-red-teaming)
...
Red Team:
- https://irregularpedia.org/cybersecurity/cyber-red-teaming
Blue Team:
- https://irregularpedia.org/general/dfp-guide
- https://irregularpedia.org/cybersecurity/cyber-incident-response-guide-personal

See all the community chats: https://forum.irregularchat.com/t/229
```

### Business Chat
[chat page](/general/business)
...
Introduce yourself, share your experiences, and outline your aspirations. For archived resources, connections, and opportunities, visit https://irregularpedia.org/general/business.
...
### Cert Chat
[chat page](/general/certifications)
...
- General Learning Resources: https://irregularpedia.org/general/learning
- Guides and Resources for Certification Pathways: https://irregularpedia.org/general/certifications
...
### Debate Chat
[chat page](/general/debate)

```
1. State Your Initial Position: Brief and Clear. Max Two Sentences.
2. Create an Ephemeral Notepad and Post the Link:https://cryptpad.irregularchat.com/pad/#/2/pad/view/+Hi8ffnuvn+ULb5FfNVSTKfiBiDX02d0Hylx7YHxxHo/
...
🌵 Welcome to the Texas Chat 🤠
Please introduce yourself AND share a piece of value you think members across Texas would benefit from—resources, tips, recommendations, or opportunities. Covering areas like San Antonio (SATX), Austin (ATX), Houston, and beyond, this is the place to connect with like-minded individuals in the Lone Star State.
...
### Full Stack Chat
```
🚀 Welcome to the Full Stack Chat! 🔧💻

This chat is for discussions on everything full-stack, covering:
🔹 System Administration & Networking – Server setup, DevOps, cloud infrastructure, security best practices.
🔹 Backend Development – Automation, scripting, API design, database management.
🔹 Frontend Development – UI/UX, frameworks, web performance optimization.

💡 Please introduce yourself and drop in your GitHub username

📚 Community Resources:
🔗 IrregularChat GitHub: github.com/irregularchat
🔗 IrregularChat Hackathons: github.com/irregularchat

This is a space to collaborate, share knowledge, and build cool things together. Let’s code! 🚀
