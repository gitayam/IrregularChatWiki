---
title: "Community Recommended Pathways/Technology Application Course"
---
...
- [Diagram](https://cryptpad.irregularchat.com/diagram/#/2/diagram/edit/rTdjtIQKdkZqLvOKn3q+IV1P/): Working graphical learning and community pathway.

- [4856-Technology Application Course Grad.pdf](#): A resource for leaders who need mentoring and skill development guidance.
  - On NIPR you can download from inteldocs [here](https://go.intelink.gov/5zXbEGU): https://go.intelink.gov/5zXbEGU
...
- **Signal Group**: Join the [Purple Team Signal Group](https://signal.group/#CjQKIFCSgs1LWgCGMbCzokVeypPIRU78xt5p9XzLozBgPafTEhCrL8EyIfHtTTM_8TA1GTHP) for networking and guidance.

**c. Read Community Wiki Pages**

- [Cyber Red Teaming Wiki](/cybersecurity/cyber-red-teaming)

- [DFP Guide Wiki](/general/dfp-guide)

- [Certifications Wiki](/general/certifications)

**d. Engage with the Community**

- **Forum**: [Irregular Chat Forum](https://forum.irregularchat.com/c/general/4) – Read tech posts and participate in discussions.

### 2. Start Self-Paced Structured Learning

- **Resource**: [DoD Funded Learning Materials](/general/learning)
...
- [Virtual Environments Guide](/general/virtual-environments)
...
- **Participate in CTFs**: Use [CTFtime](https://ctftime.org), [PicoCTF](https://picoctf.org), and [OverTheWire](https://overthewire.org).

- **Contribute to Open Source**: Improve cybersecurity tools or share your own.

### 4. Expand Your Network

- **General Tech Discussions**: Join [Tech Chat (General)](https://signal.group/#CjQKICEhFy25GcVHP90FAYQHnKVeDXYl_GfHaKb4VDzlc5v7EhBzGz_G4bPbBDsFDgX0XQdt).
