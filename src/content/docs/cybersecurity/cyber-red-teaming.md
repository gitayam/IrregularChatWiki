---
title: "Cyber Red Teaming"
tags: ["security", "cybersecurity", "red-team", "pentesting"]
---

# Cyber Red Teaming

## Red Teaming Discussion and Resources
This section expands on the application of red teaming tactics and includes relevant resources for practical use. See the [section](/general/certifications) for details on certifications. For strategies in Digital Force Protection (DFP), refer to the [Force Protection Guide](/general/dfp-guide).
...
- Tutorials on effective tool usage, focusing on ethical hacking tools, social engineering methods, and physical intrusion techniques.
  - [Tracking Guide](/general/location-tracking): Effective methods and tools for tracking individuals or devices.
  - [Entry](/general/physical-entry): Techniques for legally and ethically testing physical security systems.
  - [Red Teaming Guide](/general/rfid-spoofing): Focuses on using RFID technology in red teaming.
  - [Puppet Creation Outline](/general/sock-puppet-accounts-creation): Guidelines for creating false personas for social engineering operations, linked to [Research Resources](/research/).
...
- Overview of secure communication platforms and encryption methods.
  - [and Smishing Guide](/general/phishing): How to secure against common phishing and smishing tactics.
  - [Security Guide](/ai-ml/email-hardening-guide): Techniques for maintaining email security during red team operations.
